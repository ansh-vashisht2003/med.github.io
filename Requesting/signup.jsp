...
<%
    ...
    if (name != null && username != null && password != null && email != null && phone_number != null) {
        ...
        try {
            ...
            ps = con.prepareStatement("INSERT INTO requesting_chemist (name, username, password, email, phone_number) VALUES (?, ?, ?, ?, ?)");
            ps.setString(1, name);
...
<head>
    <meta charset="UTF-8">
    <title>Requesting Chemist Signup</title>
...
<body>
    <h1>Requesting Chemist Signup</h1>
