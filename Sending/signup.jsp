...
<%
    ...
    if (name != null && username != null && password != null && email != null && phone_number != null) {
        ...
        try {
            ...
            ps = con.prepareStatement("INSERT INTO supplying_chemist (name, username, password, email, phone_number) VALUES (?, ?, ?, ?, ?)");
            ps.setString(1, name);
...
<head>
    <meta charset="UTF-8">
    <title>Supplying Chemist Signup</title>
